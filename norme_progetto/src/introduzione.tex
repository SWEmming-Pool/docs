...
\begin{itemize}
    \item Capitolato d'appalto C7: \textbf{Trustify - Authentic and verifiable reviews platform}: \\
          ...
          \hfill\break [Ultimo accesso: \today] % TODO: aggiungere data valida
\end{itemize}
\subsubsection{Riferimenti informativi}
\begin{itemize}
    \item \textbf{Standard ISO/IEC 12207:1995}: \url{https://www.math.unipd.it/~tullio/IS-1/2009/Approfondimenti/ISO_12207-1995.pdf} \hfill\break [Ultimo accesso: \today]; % TODO: aggiungere data valida
    ...
    \item \textbf{Angular coding style guide}: \url{https://angular.io/guide/styleguide} \hfill\break [Ultimo accesso: 2023-03-21]; % TODO: aggiungere data valida
    \item \textbf{Solidity coding style guide}: \url{https://docs.soliditylang.org/en/v0.8.19/style-guide.html} \hfill\break [Ultimo accesso: 2023-03-21]; % TODO: aggiungere data valida
\end{itemize}
