...
\begin{itemize}
    ...
    \item \textbf{Angular coding style guide}: \url{https://angular.io/guide/styleguide} \hfill\break [Ultimo accesso: 2023-03-21];
    \item \textbf{Solidity coding style guide}: \url{https://docs.soliditylang.org/en/v0.8.19/style-guide.html} \hfill\break [Ultimo accesso: 2023-03-21];
\end{itemize}
