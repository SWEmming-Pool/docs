...
Come riportare sopra, ogni rischio ha un grado di pericolisità: \textbf{A} (Alto), \textbf{M} (Medio), \textbf{B} (Basso).
...
\rowcolors[]{1}{gray!55}{white}
	\begin{tabular}{c | c | p{11cm}  }
        ...
        \multicolumn{1}{c}{\color[HTML]{FFFFFF} \textbf{Codice}} &
        \multicolumn{1}{c}{\color[HTML]{FFFFFF} \textbf{Pericolo}} &
        \multicolumn{1}{c}{\color[HTML]{FFFFFF} \textbf{Piano di contingenza}} \\
