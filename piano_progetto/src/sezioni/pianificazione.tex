...
Sebastiano Sanson           & 2 & 13 & 1 & 2 & 18 & 5 & 41 \\
    ...
    % & & & & & & &
    \rowcolor{white}
    \caption{Distribuzione delle ore nel periodo di progettazione di dettaglio e codifca dei requisiti }
\end{xltabular}
...
\begin{xltabular}{\textwidth} {
    ...
    % & & & & & & &
    \rowcolor{white}
    \caption{Prospetto dei costi per ruolo nel periodo di progettazione di dettaglio e codifca dei requisiti }
\end{xltabular}
