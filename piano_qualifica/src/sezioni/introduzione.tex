...
Questo documento ha lo scopo di mostrare le strategie di verifica e validazione adottate dal \groupName al fine di garantire la qualità di prodotto e di processo. Per raggiungere questo obiettivo viene applicato un sistema di verifica continua sui processi in corso e sulle attività svolte. In questo modo è quindi possibile rilevare e correggere all’istante eventuali anomalie, riducendo al minimo lo spreco di tempo e quindi risorse.\\
Il Piano di Qualifica è un documento su cui si prevede di lavorare l’intera durata del progetto. Molti dei contenuti del documento sono di natura instabile. Alcune parti del documento sono prodotte in fasi temporali successive. Per tutte queste ragioni, il documento è prodotto in maniera incrementale, e i suoi contenuti iniziali sono da considerarsi incompleti: subiranno significative aggiunte e modifiche nel tempo.
