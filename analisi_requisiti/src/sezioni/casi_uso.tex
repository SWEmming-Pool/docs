\section{Casi d'uso}
    ...
    \subsection{Attori}
        ...
        \subsubsection{Attori primari}
            ...
            \paragraph*{Utilizzatore API:} utente autenticato che utilizza l'API REST per ottenere le recensioni associate a se stesso in formato \textit{JSON}\glo, senza passare per la \textit{web app}.
    ...
    \subsection{Elenco}
        ...
        \label{UC08}
            ...
            \begin{table}[H]
                ...
                \begin{tabularx}{0.9\textwidth} {
                    ...
                    \textbf{Scenario principale} &
                        \begin{enumerate}
                            \item L'utente rilascia una recensione ad una transazione che è già stata recensita o che non rispetta un formato valido, ovvero non rispetta i seguenti vincoli:
                            \begin{itemize}
        ...
        \label{UC13}
            ...
            \begin{table}[H]
                ...
                \begin{tabularx}{0.9\textwidth} {
                    ...
                    \textbf{Attore primario} & Utente generico \\
                    \hline
                    \textbf{Precondizioni} & L'utente ha effettuato una ricerca delle recensioni. \\
                    \hline
        ...
        \label{UC14}
            ...
            \begin{figure}[H]
                \centering
                \includegraphics[scale=0.6]{src/img/UC14.png}
                \caption{UC14}
            \end{figure}
        ...
        \label{UC15}
            ...
            \begin{figure}[H]
                \centering
                \includegraphics[scale=0.6]{src/img/UC15.png}
                \caption{UC15}
            \end{figure}
        ...
        \subsubsection{UC16 - Errore Visualizzazione}
        \label{UC16}
        ...
        \label{UC17}
            ...
            \begin{figure}[H]
                \centering
                \includegraphics[scale=0.6]{src/img/UC17.png}
                \caption{UC17}
            \end{figure}
