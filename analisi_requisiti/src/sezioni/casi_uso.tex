\section{Casi d'uso}
    ...
    \subsection{Attori}
        ...
        \subsubsection{Attori primari}
            ...
            \paragraph*{Utilizzatore API:} utente generico che utilizza l'API REST per ottenere le recensioni, associate ad un indirizzo, in formato \textit{JSON}\glo, senza passare per la \textit{web app}.
    ...
    \subsection{Elenco}
        ...
        % UC14: Errore Visualizzazione Lista Recensioni (per UC13, 14, 15)
