            ...
            \label{UC03}
                ...
                \begin{table}[H]
                    ...
                    \begin{tabularx}{0.9\textwidth} {
                        ...
                        \hline
                        \textbf{Scenario principale} & L'utente effettua il pagamento verso un altro wallet. \\
                        \hline
                        \textbf{Estensioni} & Se l'operazione non va a buone fine, si verifica \hyperref[UC04]{UC04}.\\
                        \hline
                    \end{tabularx}
                    \caption{UC03}
                \end{table}
