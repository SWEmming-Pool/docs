\section{Descrizione generale}
    ...
    Per usufruire del servizio, l'utente deve disporre di una connessione ad Internet e di un browser con installata l'estensione \textit{MetaMask}\glo, disponibile solo per \textit{Chrome} e \textit{Firefox}.