\section{Requisiti}
    ...
    \subsection{Tracciamento fonte-requisiti}
        ...
        \begin{xltabular}{0.9\textwidth} {
            ...
            \hyperref[UC08]{UC08} &
            R1F5.3, R1F5.3.1, R1F5.3.2, R1F5.3.3 \\
            \hline
