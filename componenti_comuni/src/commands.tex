...
\newcommand{\documentEditors}{Fabio Pantaleo, Nicolò Trinca, Ennio Italiano} % Editori
\newcommand{\documentVerifiers}{Sebastiano Sanson} % Verificatori
...
\newcommand{\rowcolorlight}{\rowcolor[HTML]{f2f2f2}} %righe chiare/dispari_change
\newcommand{\rowcolordark}{\rowcolor[HTML]{e5e5e5}} %righe scure/pari_change
